        ...
        <div className="bg-white border border-[#0B3F3D]/10 rounded-2xl shadow-md p-6 flex flex-col gap-3">
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div className="text-right">
              <p className="text-sm text-gray-500">تعديل بيانات الشهيد</p>
          ...
          <p className="text-gray-600 leading-relaxed">
            تأكد من تحديث بيانات الاستشهاد، المعلومات الشخصية، والوسائط قبل
            الحفظ. يمكنك رفع صور أو فيديوهات جديدة أو حذف الوسائط القديمة.
          </p>
        </div>
